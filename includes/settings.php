...
$fb_width = 346; /* flip book width in pixels (without border) */
$fb_height = 490; /* flip book height in pixels (without border) */
...
$border_size = 10; /* size in pixels */
$border_outline = true; /* outline around the pages*/
...
$zoom_overlay_opacity = 0.2; /* opacity of the overlay */
